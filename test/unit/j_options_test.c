...
void test_chunk_size_opt() {
    test_case_t cases[] = {
            ...
            {.argc = 3, .argv = {"jpipe", "--chunk-size", "-1", NULL}, .err=J_ECHUNK_SIZE, .chunk_size = J_CHUNK_SIZE_DEF},
            {.argc = 3, .argv = {"jpipe", "--chunk-size", "", NULL}, .err=J_ECHUNK_SIZE, .chunk_size = J_CHUNK_SIZE_DEF},
            {.argc = 3, .argv = {"jpipe", "--chunk-size", "A", NULL}, .err=J_ECHUNK_SIZE, .chunk_size = J_CHUNK_SIZE_DEF},
            {.argc = 3, .argv = {"jpipe", "--chunk-size", "0kb", NULL}, .err=J_ECHUNK_SIZE, .chunk_size = J_CHUNK_SIZE_DEF},
            {.argc = 3, .argv = {"jpipe", "--chunk-size", "65537kb", NULL}, .err=J_ECHUNK_SIZE, .chunk_size = J_CHUNK_SIZE_DEF},
            {.argc = 3, .argv = {"jpipe", "--chunk-size", "10Kb", NULL}, .err=J_ECHUNK_SIZE, .chunk_size = J_CHUNK_SIZE_DEF},
            {.argc = 3, .argv = {"jpipe", "--chunk-size", "10kbx", NULL}, .err=J_ECHUNK_SIZE, .chunk_size = J_CHUNK_SIZE_DEF},
            {.argc = 3, .argv = {"jpipe", "--chunk-size", "0mb", NULL}, .err=J_ECHUNK_SIZE, .chunk_size = J_CHUNK_SIZE_DEF},
            {.argc = 3, .argv = {"jpipe", "--chunk-size", "65mb", NULL}, .err=J_ECHUNK_SIZE, .chunk_size = J_CHUNK_SIZE_DEF},
            {.argc = 3, .argv = {"jpipe", "--chunk-size", "64Mb", NULL}, .err=J_ECHUNK_SIZE, .chunk_size = J_CHUNK_SIZE_DEF},
            {.argc = 3, .argv = {"jpipe", "--chunk-size", "64mbx", NULL}, .err=J_ECHUNK_SIZE, .chunk_size = J_CHUNK_SIZE_DEF},
...
void test_out_dir() {
    test_case_t cases[] = {
            ...
            {.argc = 3, .argv = {"jpipe", "-o", "", NULL}, .err= J_EOUT_DIR, .out_dir = J_OUTDIR_DEF},
            {.argc = 3, .argv = {"jpipe", "-o", "/tmp", NULL}, .err= 0, .out_dir = "/tmp"},
            {.argc = 3, .argv = {"jpipe", "--out-dir", "", NULL}, .err= J_EOUT_DIR, .out_dir = J_OUTDIR_DEF},
